...
**PROJECT FOCUS**
1. Collect data through webscrapping, including text data
1. Process the text data, along with other relevant data if you have, appropriately
1. Come up with classification models that uses the text data, along with other relevant data if you have, to address the problem statement.

### Suggested Approach:
For project 3, you may consider the following suggestions:
...
- **Create and compare at least two models**. 
    - They must be Naive Bayes and Random Forest classifiers.
    - You can include other models: logistic regression, KNN, SVM, etc.
